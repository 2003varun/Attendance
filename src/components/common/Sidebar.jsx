...
export function Sidebar() {
    ...
    const [dbStaffCount, setDbStaffCount] = useState(11);
                    ...
                    <li className="nav-item">
                        <NavLink to="/records" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                            <span className="nav-left">
                                ...
                                <span className="nav-label">Punch Records</span>
                            </span>
                            {rawData.length > 0 && (
                    ...
                    <li className="nav-item">
                        <NavLink to="/holidays" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                            <span className="nav-left">
                                ...
                                <span className="nav-label">Holiday Calendar</span>
                            </span>
                        </NavLink>
                    </li>
                    ...
                    <li className="nav-item">
                        <NavLink to="/raw" className={({ isActive }) => `nav-link ${isActive ? 'active' : ''}`}>
                            <span className="nav-left">
                                ...
                                <span className="nav-label">Raw Device Logs</span>
                            </span>
                        </NavLink>
                    </li>
            ...
            <div className="sidebar-footer">
                <div className="status-pill">
                    ...
                    <span id="sideStatusText" className="status-text">
                        {datasetName && datasetName !== "Saved Workspace" ? datasetName.toUpperCase() : "DEMO AUGUST LOADED"}
                    </span>
                </div>
